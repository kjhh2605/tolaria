...
export const OPEN_AI_CHAT_EVENT = 'hs-hub:open-ai-chat'
export const AI_PROMPT_QUEUED_EVENT = 'hs-hub:ai-prompt-queued'
export const NEW_AI_CHAT_EVENT = 'hs-hub:new-ai-chat'
